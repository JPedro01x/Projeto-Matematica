    ...
    const loadResults = async () => {
      try {
        ...
        if (playersData && playersData.length) {
          ...
          const sortedPlayers = (playersData as Player[]).sort((a, b) => b.correct_answers_count - a.correct_answers_count);
    ...
    <div className="min-h-screen bg-hero pb-10">
      ...
      <main className="max-w-4xl mx-auto px-6 py-8">
        ...
        <div className="grid md:grid-cols-3 gap-4 mt-8">
          ...
          <Card className="p-4 rounded-2xl text-center bg-gradient-to-br from-sky-50 to-cyan-50 border-sky-200">
            <p className="text-sm text-sky-700 font-medium mb-1">Média de Acertos</p>
